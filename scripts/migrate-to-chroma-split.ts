...
export class SplitChromaMigrationService {
  ...
  async initialize() {
    console.log('🚀 Initializing Split ChromaDB Migration Service...');
  ...
  async migrateAllData() {
    console.log('\n🔄 Starting split data migration to ChromaDB...\n');
...
async function main() {
  console.log('🚀 Split ChromaDB Migration Script');
  console.log('==================================\n');
  ...
  try {
    ...
    console.log('\n✅ Split migration completed successfully!');
